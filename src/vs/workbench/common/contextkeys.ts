...
export const WorkspaceFolderCountContext = new RawContextKey<number>(
	...
	0,
	localize('workspaceFolderCount', 'The number of root folders in the workspace')
);
...
export const DirtyWorkingCopiesContext = new RawContextKey<boolean>(
	'dirtyWorkingCopies',
	false,
	localize('dirtyWorkingCopies', 'Whether there are any working copies with unsaved changes')
);
...
export const VirtualWorkspaceContext = new RawContextKey<string>(
	'virtualWorkspace',
	'',
	localize('virtualWorkspace', 'The scheme of the current workspace is from a virtual file system or an empty string.')
);
export const TemporaryWorkspaceContext = new RawContextKey<boolean>(
	'temporaryWorkspace',
	false,
	localize('temporaryWorkspace', 'The scheme of the current workspace is from a temporary file system.')
);

export const IsSessionsWindowContext = new RawContextKey<boolean>(
	'isSessionsWindow',
	false,
	localize('isSessionsWindow', 'Whether the current window is a agent sessions window.')
);
...
export const EmbedderIdentifierContext = new RawContextKey<string | undefined>(
	'embedderIdentifier',
	undefined,
	localize('embedderIdentifier', 'The identifier of the embedder according to the product service, if one is defined')
);

export const InAutomationContext = new RawContextKey<boolean>(
	'inAutomation',
	false,
	localize('inAutomation', 'Whether VS Code is running under automation/smoke test')
);
...
export const IsAuxiliaryWindowFocusedContext = new RawContextKey<boolean>(
	...
	false,
	localize('isAuxiliaryWindowFocusedContext', 'Whether an auxiliary window is focused')
);

export const IsWindowAlwaysOnTopContext = new RawContextKey<boolean>(
	'isWindowAlwaysOnTop',
	false,
	localize('isWindowAlwaysOnTop', 'Whether the window is always on top')
);

export const IsAuxiliaryWindowContext = new RawContextKey<boolean>(
	'isAuxiliaryWindow',
	false,
...
export const ActiveEditorDirtyContext = new RawContextKey<boolean>(
	'activeEditorIsDirty',
	false,
	localize('activeEditorIsDirty', 'Whether the active editor has unsaved changes')
);
export const ActiveEditorPinnedContext = new RawContextKey<boolean>(
	'activeEditorIsNotPreview',
	false,
	localize('activeEditorIsNotPreview', 'Whether the active editor is not in preview mode')
);
export const ActiveEditorFirstInGroupContext = new RawContextKey<boolean>(
	'activeEditorIsFirstInGroup',
	false,
	localize('activeEditorIsFirstInGroup', 'Whether the active editor is the first one in its group')
);
export const ActiveEditorLastInGroupContext = new RawContextKey<boolean>(
	'activeEditorIsLastInGroup',
	false,
	localize('activeEditorIsLastInGroup', 'Whether the active editor is the last one in its group')
);
...
export const ActiveEditorReadonlyContext = new RawContextKey<boolean>(
	...
	false,
	localize('activeEditorIsReadonly', 'Whether the active editor is read-only')
);
export const ActiveCompareEditorCanSwapContext = new RawContextKey<boolean>(
	'activeCompareEditorCanSwap',
	false,
	localize('activeCompareEditorCanSwap', 'Whether the active compare editor can swap sides')
);
export const ActiveEditorCanToggleReadonlyContext = new RawContextKey<boolean>(
	'activeEditorCanToggleReadonly',
	true,
	localize('activeEditorCanToggleReadonly', 'Whether the active editor can toggle between being read-only or writeable')
);
...
export const ActiveEditorAvailableEditorIdsContext = new RawContextKey<string>(
	...
	'',
	localize('activeEditorAvailableEditorIds', 'The available editor identifiers that are usable for the active editor')
);
export const TextCompareEditorVisibleContext = new RawContextKey<boolean>(
	'textCompareEditorVisible',
	false,
	localize('textCompareEditorVisible', 'Whether a text compare editor is visible')
);
...
export const ActiveEditorGroupLastContext = new RawContextKey<boolean>(
	...
	false,
	localize('activeEditorGroupLast', 'Whether the active editor group is the last group')
);
export const ActiveEditorGroupLockedContext = new RawContextKey<boolean>(
	'activeEditorGroupLocked',
	false,
	localize('activeEditorGroupLocked', 'Whether the active editor group is locked')
);
...
export const MultipleEditorsSelectedInGroupContext = new RawContextKey<boolean>(
	...
	false,
	localize('multipleEditorsSelectedInGroup', 'Whether multiple editors have been selected in an editor group')
);
export const TwoEditorsSelectedInGroupContext = new RawContextKey<boolean>(
	'twoEditorsSelectedInGroup',
	false,
	localize('twoEditorsSelectedInGroup', 'Whether exactly two editors have been selected in an editor group')
);
...
export const EditorPartMultipleEditorGroupsContext = new RawContextKey<boolean>(
	...
	false,
	localize('editorPartMultipleEditorGroups', 'Whether there are multiple editor groups opened in an editor part')
);
...
export const EditorPartMaximizedEditorGroupContext = new RawContextKey<boolean>(
	...
	false,
	localize('editorPartEditorGroupMaximized', 'Editor Part has a maximized group')
);

export const EditorPartModalContext = new RawContextKey<boolean>(
	'editorPartModal',
	false,
	localize('editorPartModal', 'Whether focus is in a modal editor part')
);
export const EditorPartModalMaximizedContext = new RawContextKey<boolean>(
	'editorPartModalMaximized',
	false,
	localize('editorPartModalMaximized', 'Whether the modal editor part is maximized')
);
export const EditorPartModalNavigationContext = new RawContextKey<boolean>(
	'editorPartModalNavigation',
	false,
	localize('editorPartModalNavigation', 'Whether the modal editor part has navigation context')
);
export const EditorPartModalSidebarContext = new RawContextKey<boolean>(
	'editorPartModalSidebar',
	false,
	localize('editorPartModalSidebar', 'Whether the modal editor part has a sidebar')
);
export const EditorPartModalSidebarVisibleContext = new RawContextKey<boolean>(
	'editorPartModalSidebarVisible',
	false,
	localize('editorPartModalSidebarVisible', 'Whether the modal editor part sidebar is visible')
);
...
export const IsMainEditorCenteredLayoutContext = new RawContextKey<boolean>(
	'isCenteredLayout',
	false,
	localize('isMainEditorCenteredLayout', 'Whether centered layout is enabled for the main editor')
);
...
export const MainEditorAreaVisibleContext = new RawContextKey<boolean>(
	...
	true,
	localize('mainEditorAreaVisible', 'Whether the editor area in the main window is visible')
);
...
export const IsCompactTitleBarContext = new RawContextKey<boolean>(
	'isCompactTitleBar',
	false,
	localize('isCompactTitleBar', 'Title bar is in compact mode')
);
...
export const AuxiliaryBarFocusContext = new RawContextKey<boolean>(
	'auxiliaryBarFocus',
	false,
	localize('auxiliaryBarFocus', 'Whether the auxiliary bar has keyboard focus')
);
...
export const PanelAlignmentContext = new RawContextKey<string>(
	'panelAlignment',
	'center',
	localize('panelAlignment', "The alignment of the panel, either 'center', 'left', 'right' or 'justify'")
);
